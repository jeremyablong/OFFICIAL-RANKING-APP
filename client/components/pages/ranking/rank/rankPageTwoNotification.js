...
class RankPageTwoNotification extends Component {
constructor(props) {
  super(props);
  ...
  this.state = {
	...
	handleRatingSubmission = () => {
		...
		axios.post(`${URL}/post/rating/interaction/confirmation`, {
			relatable,
			entertaining, 
			offensive, 
			respectful, 
...
export default connect(mapStateToProps, {  })(RankPageTwoNotification);